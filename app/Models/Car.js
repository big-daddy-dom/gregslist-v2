  ...
  get CardTemplate() {
    ...
    <div class="car col-md-4 p-4">
      <div class="bg-white shadow rounded">
        ...
        <div class="p-3">
          <p class="text-center uppercase"><b>${this.make} - ${this.model} - ${this.year}<i class=" mdi mdi-pencil selectable" onclick="app.carsController.openEditor('${this.id}')">pencil</i></b></p>
